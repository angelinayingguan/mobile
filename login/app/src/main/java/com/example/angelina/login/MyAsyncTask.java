...
public class MyAsyncTask extends AsyncTask<String, Void, ArrayList<MenuLunch>> {
    ...
    @Override
    protected ArrayList<MenuLunch> doInBackground(String... params) {
        // get the string from params, which is an array
        String date = params[0];

        Scraper scrap1 = new Scraper(){};
        ArrayList<MenuLunch> items = new ArrayList<>();
        try{
...
//        }
    ...
    protected void onPostExecute(ArrayList<MenuLunch> result1) {
